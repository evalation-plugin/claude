...
function stripNotes(xml) {
  ...
  // A shape is the note's own only where it lies wholly within the note's height. Overlapping was
  // enough before, and a short block's accent bar just below a note was taken as the note's.
